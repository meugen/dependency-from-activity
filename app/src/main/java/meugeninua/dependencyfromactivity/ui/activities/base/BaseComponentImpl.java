...
public abstract class BaseComponentImpl<A extends AppCompatActivity> implements ActivityComponent {

    private final AppComponent appComponent;
    private final WeakReference<A> activityRef;

    protected BaseComponentImpl(final AppComponent appComponent, final A activity) {
